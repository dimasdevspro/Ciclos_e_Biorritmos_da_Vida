    ...
    <>
      ...
      <div className="container mx-auto bg-blue-50 px-4 py-8 min-h-screen">
        ...
        <p className="text-lg mb-6">
          Descubra como os ciclos naturais influenciam sua vida e aprenda a
          viver em harmonia com eles, se aproximando de como as civilizações
          antigas tentavam usar o conhecimento dos ciclos para melhorar sua
          saúde, produtividade e bem-estar. Com nossa calculadora de biorritmos,
          você pode:
        </p>
        <p className="text-lg mb-6">
          <ul className="list-disc list-inside mb-4">
            ...
            <li>
              Planejar suas atividades de acordo com seus picos de energia
            </li>
