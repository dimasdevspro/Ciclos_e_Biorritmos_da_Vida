  ...
  return (
    <>
      <SEO
        ...
        description="Página dedicada à política de privacidade do site."
        keywords="biorritmo, biorritmo online, biorritmo físico, biorritmo emocional"
        url="https://ciclosebiorritmos.com/privacidade"
      />
      <div className="bg-blue-50 flex flex-col min-h-screen p-6">
        ...
        <p className="mb-4">
          ...
          data de nascimento) com a finalidade exclusiva de cálculo de
          biorritmos.
        </p>
        ...
        <p className="mb-4">
          Os dados são utilizados apenas durante a sessão ativa e descartados
          após o uso.
        </p>
        ...
        <p className="mb-4">
          Ao utilizar este aplicativo, você concorda com o uso dos dados
