...
export default function Disclaimer() {
  return (
    <>
      <SEO
        title="Aviso Legal"
        description="Página dedicada ao Aviso Legal do Projeto"
        keywords="biorritmo, biorritmo online, biorritmo físico, biorritmo emocional"
        url="https://ciclosebiorritmos.com/avisolegal"
      />
      <div className="bg-blue-50 flex flex-col min-h-screen p-6">
        ...
        <p className="mb-4">
          Todo o conteúdo disponibilizado neste site tem finalidade
          exclusivamente educativa e informativa. Os artigos procuram apresentar
          temas históricos, científicos, matemáticos e culturais de forma
          acessível, incentivando o estudo, a reflexão e o autoconhecimento.
        </p>
        ...
        <p className="mb-4">
          ...
          científico. Os resultados apresentados devem ser compreendidos como
          uma representação matemática desse modelo tradicional.
        </p>
        ...
        <p className="mb-4">
          ...
          apresentar aspectos históricos, antropológicos e culturais
          desenvolvidos por diferentes civilizações ao longo da história.
        </p>
        ...
        <p className="mb-4">
          ...
          médica, psicológica, psiquiátrica, nutricional, jurídica, financeira
          ou de qualquer outro profissional qualificado.
        </p>
        ...
        <p className="mb-4">
          ...
          exclusiva nas informações apresentadas pela calculadora ou pelos
          artigos deste projeto.
        </p>
        ...
        <p className="mb-4">
          O conteúdo é elaborado com base em referências históricas,
          conhecimentos científicos consolidados quando aplicáveis e literatura
          relacionada aos temas abordados. Apesar do cuidado na preparação do
          material, podem ocorrer revisões, atualizações ou correções ao longo
          do tempo.
        </p>
        ...
        <p className="mb-4">
          ...
          anúncios, respeitando sempre a Política de Privacidade disponível
          neste site.
        </p>
