...
export default function TermsOfUse() {
  return (
    <>
      <SEO
        title="Termos de Uso"
        description="Página dedicada aos termos de uso do site."
        keywords="biorritmo, biorritmo online, biorritmo físico, biorritmo emocional"
        url="https://ciclosebiorritmos.com/termosdeuso"
      />
      <div className="bg-blue-50 flex flex-col min-h-screen p-6">
        <h1 className="text-2xl font-bold mb-6">Termos de Uso</h1>

        <p className="mb-4">
          Bem-vindo ao <strong>Ciclos e Biorritmos da Vida</strong>. Ao acessar
          ou utilizar este aplicativo, você concorda com os presentes Termos de
          Uso. Caso não concorde com qualquer uma das condições aqui descritas,
        ...
        <p className="mb-4">
          ...
          de autoconhecimento. O conteúdo disponibilizado reúne informações
          sobre biorritmos, astronomia, ciclos naturais, história das
          civilizações e aspectos culturais relacionados à observação do tempo e
          do céu.
        </p>

        <p className="mb-4">
          Os cálculos apresentados são baseados na teoria clássica dos
          biorritmos, utilizando modelos matemáticos conhecidos e descritos ao
          longo da literatura histórica sobre o tema.
        </p>
        ...
        <p className="mb-4">
          Os resultados fornecidos pela calculadora possuem caráter
          exclusivamente informativo e recreativo. Eles não constituem
          diagnóstico médico, psicológico, psiquiátrico, financeiro, jurídico ou
          qualquer outro tipo de aconselhamento profissional.
        </p>
        ...
        <p className="mb-4">
          ...
          acessível ao público. Quando abordados temas ligados ao simbolismo ou
          a tradições antigas, estes são apresentados em seu contexto histórico
          e cultural.
        </p>
        ...
        <p className="mb-4">
          A calculadora utiliza apenas a data de nascimento informada pelo
          usuário para gerar os gráficos e cálculos dos ciclos de biorritmos
          durante a sessão ativa do navegador.
        </p>
        ...
        <p className="mb-4">
          ...
          refletir melhorias no projeto, alterações legais ou novos recursos. A
